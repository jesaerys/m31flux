...
\nuv{} images. The creation of \sfr{} maps both from the \sfh{s} and the
...
\ref{fig:nuvsfrratio} using \sfrxz{}, the \sfr{s} derived from the synthetic
...
distributions. Deriving \sfr{s} from published flux calibrations is therefore
